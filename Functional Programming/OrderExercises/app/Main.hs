...
--   | otherwise                = bestSum : collapse currentSums bestSums
-- collapse [] _ = []
-- collapse _ [] = []
...
positiveSequences previousNumberNegative currentSums bestSums [] = show previousNumberNegative <> show currentSums <> show bestSums <> show newBestSums
  where
    newBestSums =
